...
<div class=\"row-space-4 row-space-top-4\">
  <div class=\"row\">
    ...
    <div class=\"col-md-3 text-center\">
      <a href=\"#host-profile\" class=\"media-photo media-round\"><img alt=\"";
        // line 546
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["gerant"]) ? $context["gerant"] : $this->getContext($context, "gerant")), "nom", array()), "html", null, true);
        echo "\" class=\"host-profile-image\" height=\"90\" nopin=\"nopin\" src=\"";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["gerant"]) ? $context["gerant"] : $this->getContext($context, "gerant")), "urlP", array()), "html", null, true);
        echo "?interpolation=lanczos-none&amp;crop=w:w;*,*&amp;crop=h:h;*,*&amp;resize=225:*&amp;output-format=jpg&amp;output-quality=70\" title=\"";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["gerant"]) ? $context["gerant"] : $this->getContext($context, "gerant")), "nom", array()), "html", null, true);
        echo "\" width=\"90\" /></a>
    </div>
  ...
  <div class=\"pf-pic-prompt text-center\">
    ...
    <i class=\"icon icon-question\" data-behavior=\"tooltip\" data-position=\"bottom\"
       title=\"La réservation instantanée vous permet de réserver un logement aussitôt, sans avoir à attendre la confirmation de l'hôte.\"></i>
        ...
        <div id=\"book-it-urgency-commitment\" data-host-name=\"";
        // line 640
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["gerant"]) ? $context["gerant"] : $this->getContext($context, "gerant")), "nom", array()), "html", null, true);
        echo "\">
...
";
    ...
    {
        return array (  1159 => 993,  1134 => 970,  1124 => 962,  1122 => 961,  1119 => 960,  1109 => 952,  1107 => 951,  1100 => 946,  1090 => 939,  1088 => 938,  1084 => 936,  1074 => 929,  1072 => 928,  1067 => 925,  1057 => 917,  1055 => 916,  1028 => 895,  1024 => 894,  1018 => 891,  1009 => 890,  1005 => 889,  1001 => 888,  975 => 865,  950 => 843,  744 => 640,  697 => 596,  682 => 584,  676 => 580,  674 => 579,  669 => 577,  661 => 574,  636 => 554,  621 => 546,  593 => 521,  569 => 499,  542 => 475,  535 => 472,  521 => 460,  495 => 437,  460 => 404,  458 => 403,  456 => 402,  453 => 401,  317 => 268,  187 => 141,  164 => 120,  162 => 119,  139 => 99,  125 => 88,  39 => 4,  36 => 3,  11 => 1,);
    }
}
