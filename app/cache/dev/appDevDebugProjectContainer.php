...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['assetic.filter.less'] = $instance = new \Assetic\Filter\LessFilter('/usr/bin/node', array(0 => '/usr/local/lib/node_modules'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'agenceimmob', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver($b, 'sprint2\\realEstateBundle\\Entity');
        $d->addDriver($b, 'sprint2\\AuthandlogBundle\\Entity');
        $d->addDriver($b, 'sprint2\\GerantBundle\\Entity');
        $d->addDriver($c, 'sprint2\\RealEstate\\AdminBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('realEstateBundle' => 'sprint2\\realEstateBundle\\Entity', 'sprint2RealEstateAdminBundle' => 'sprint2\\RealEstate\\AdminBundle\\Entity', 'sprint2AuthandlogBundle' => 'sprint2\\AuthandlogBundle\\Entity', 'sprint2GerantBundle' => 'sprint2\\GerantBundle\\Entity'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \sprint2\restBundle\Handler\offreHandler A sprint2\restBundle\Handler\offreHandler instance.
     */
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('stackoverflow.agenceimmob@gmail.com');
        $a->setPassword('esprit3a19');
        $a->setAuthMode('login');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'BraincraftedBootstrapBundle:Form:bootstrap.html.twig', 2 => 'bootstrap_3_layout.html.twig'), 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'BraincraftedBootstrapBundle:Form:bootstrap.html.twig', 2 => 'bootstrap_3_layout.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ac7ef6ab6a2555d91f23ed90492abfc1f0cb1bb4');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'realEstateBundle' => 'sprint2\\realEstateBundle\\realEstateBundle',
                ...
                'sprint2GerantBundle' => 'sprint2\\GerantBundle\\sprint2GerantBundle',
                'sprint2restBundle' => 'sprint2\\restBundle\\sprint2restBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'agenceimmob',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'stackoverflow.agenceimmob@gmail.com',
            'mailer_password' => 'esprit3a19',
            'locale' => 'en',
            'secret' => 'ac7ef6ab6a2555d91f23ed90492abfc1f0cb1bb4',
            ...
            'kernel.secret' => 'ac7ef6ab6a2555d91f23ed90492abfc1f0cb1bb4',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'stackoverflow.agenceimmob@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'esprit3a19',
